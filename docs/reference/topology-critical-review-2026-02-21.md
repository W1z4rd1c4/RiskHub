...
| Canonical docs tree | `python3 scripts/tools/docs_tree_audit.py --scope canonical --output-dir tests/results/docs/topology-critical-review-20260221-235221/docs-tree-canonical` | PASS | `tests/results/docs/topology-critical-review-20260221-235221/docs-tree-canonical/docs-tree-audit.json` |
...
|---|---|---|
| Canonical unresolved links are zero | PASS | `tests/results/docs/topology-critical-review-20260221-235221/docs-tree-canonical/docs-tree-audit.json` (`summary.canonical_unresolved_count=0`) |
| Required entrypoints and cross-links are present | PASS | `tests/results/docs/topology-critical-review-20260221-235221/docs-tree-canonical/docs-tree-audit.json` (`summary.entrypoint_missing_count=0`, `summary.crosslink_missing_count=0`) |
| Documented topology commands in `docs/README.md:40` and `docs/README.md:43` execute successfully | PASS | `tests/results/docs/topology-critical-review-20260221-235221/command-status.json` |
| All numeric claims in `.planning/codebase/STRUCTURE.md:22` and `.planning/codebase/STRUCTURE.md:50` match repository reality | FAIL | `tests/results/docs/topology-critical-review-20260221-235221/count-metrics.json`, `tests/results/docs/topology-critical-review-20260221-235221/claim-matrix.json` |
| Canonical docs are navigable from roots (`AGENTS.md`, `docs/README.md`, `.planning/README.md`) within 3 hops | FAIL | `tests/results/docs/topology-critical-review-20260221-235221/navigability.json` (`unreachable_count=28`) |
...
- **Summary:** 9/9 numeric claims in `.planning/codebase/STRUCTURE.md:22` to `.planning/codebase/STRUCTURE.md:50` are out of date.
- **Impact:** planning, audit, and architecture readers can be misled by obsolete module/test/component counts.
- **Evidence:**
  - `.planning/codebase/STRUCTURE.md:22`
  - `.planning/codebase/STRUCTURE.md:50`
  - `tests/results/docs/topology-critical-review-20260221-235221/count-metrics.json`
...
- **Evidence:**
  - `tests/results/docs/topology-critical-review-20260221-235221/navigability.json`
  - `docs/DOCUMENTATION_TREE.md:5`
...
- **Summary:** `.planning/codebase/STRUCTURE.md:3` and `.planning/codebase/ARCHITECTURE.md:3` show recent analysis dates, but structural count claims are stale.
...
- **Evidence:**
  - `tests/results/docs/topology-critical-review-20260221-235221/command-status.json`
  - `tests/results/docs/topology-critical-review-20260221-235221/docs-tree-canonical/docs-tree-audit.json`
...
- `tests/results/docs/topology-critical-review-20260221-235221/metadata.json`
- `tests/results/docs/topology-critical-review-20260221-235221/command-status.json`
- `tests/results/docs/topology-critical-review-20260221-235221/docs-tree-canonical/docs-tree-audit.json`
- `tests/results/docs/topology-critical-review-20260221-235221/docs-tree-canonical/docs-tree-audit.md`
- `tests/results/docs/topology-critical-review-20260221-235221/count-metrics.json`
- `tests/results/docs/topology-critical-review-20260221-235221/navigability.json`
- `tests/results/docs/topology-critical-review-20260221-235221/claim-matrix.json`
- `tests/results/docs/topology-critical-review-20260221-235221/findings.json`
- `tests/results/docs/topology-critical-review-20260221-235221/backlog.json`
