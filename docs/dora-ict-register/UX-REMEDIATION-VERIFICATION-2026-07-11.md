...
| `SortableTable` blast radius understated | **CONFIRMED** | **11 files / 19 sites** (Controls/Departments/Issues/KRIs/Risks/Vendors list + the new ones). Phase 3 acceptance now requires regression coverage across all consumers. |
