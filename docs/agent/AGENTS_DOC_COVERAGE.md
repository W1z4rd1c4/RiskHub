...
|---|---|---|---|---|---|
| repository_knowledge_map | `Repository Knowledge Map` | `docs/agent/README.md`; `docs/agent/AGENTS_DOC_COVERAGE.md` | full | none | 2026-02-16 |
...
| postgres_test_mode | `Postgres test mode` | `docs/agent/PYTEST_RUNTIME_NOTES.md`; `.planning/codebase/TESTING.md` | full | none | 2026-02-16 |
