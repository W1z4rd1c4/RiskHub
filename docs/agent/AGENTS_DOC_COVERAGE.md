...
| source_of_truth_order | `Source-of-Truth Order` | `docs/agent/CODEX_WORKING_RULES.md`; `.planning/codebase/CONVENTIONS.md` | full | none | 2026-04-25 |
...
| rbac_business_logic_guardrails | `RBAC and Business Logic Guardrails` | `docs/BUSINESS_LOGIC.md`; `.planning/codebase/CONCERNS.md` | full | none | 2026-04-25 |
