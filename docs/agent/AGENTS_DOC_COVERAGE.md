...
| project_map | `Project Map` | `.planning/codebase/STRUCTURE.md`; `.planning/codebase/ARCHITECTURE.md` | full | none | 2026-04-05 |
...
| testing_matrix | `Testing Matrix` | `.planning/codebase/TESTING.md`; `docs/TESTING.md` | full | none | 2026-04-05 |
...
| demo_dev_auth_local | `Demo/Dev Auth (local)` | `scripts/install.sh`; `scripts/dev.sh`; `docs/development/README.md`; `.planning/codebase/INTEGRATIONS.md` | full | none | 2026-04-05 |
