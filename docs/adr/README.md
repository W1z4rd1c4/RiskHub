...
This directory records architecture decisions that should not be re-litigated by future audits without new evidence.

## Index

- [ADR-001 Capabilities Module Unification](./ADR-001-capabilities-module-unification.md)
- [ADR-002 Service-Owned Transactions](./ADR-002-service-owned-transactions.md)
- [ADR-003 Domain Exception Taxonomy](./ADR-003-domain-exception-taxonomy.md)
