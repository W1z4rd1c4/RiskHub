...
SERVICE_ROOT = REPO_ROOT / "backend/app/services/_riskhub_config"
ALLOWLIST_PATH = REPO_ROOT / "tests/backend/pytest/architecture/_riskhub_config_service_commit_allowlist.toml"
