...
describe('Department alternate evidence exports', () => {
    it.each([
        ...
        ['Issue', 'src/pages/issues/useIssuesPageState.ts', 'exportIssueEvaluation'],
    ])('%s dated export retains the immutable Department', (_name, path, exportName) => {
