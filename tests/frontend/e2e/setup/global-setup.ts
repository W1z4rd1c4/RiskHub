...
async function globalSetup(config: FullConfig): Promise<void> {
    ...
    console.log(
        `✅ Deterministic fixtures verified (risks=${preflight.counts.risks}, controls=${preflight.counts.controls}, KRIs=${preflight.counts.kris}, vendors=${preflight.counts.vendors}, processes=${preflight.counts.processes}, assets=${preflight.counts.assets}, threats=${preflight.counts.threats}, approvals_pending=${preflight.counts.approvals_pending}, approvals_my_requests=${preflight.counts.approvals_my_requests}, activity_seeded=${preflight.counts.activity_seeded})`,
    );
