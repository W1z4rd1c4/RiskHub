...
export const E2E_SENSITIVE_APPROVALS = {
    RISK_OWNER_CHANGE: {
        ...
        action: 'edit',
        status: 'pending',
        fieldLabel: 'Accountable owner',
        oldDisplayValue: 'Eva Králová',
        newDisplayValue: 'Martin Procházka',
    },
    RISK_DEPARTMENT_CHANGE: {
        ...
        action: 'edit',
        status: 'pending',
        fieldLabel: 'Owning Department',
        oldDisplayValue: 'Operations',
        newDisplayValue: 'Finance',
    },
    RISK_CATEGORY_CHANGE: {
        ...
        status: 'pending',
        fieldLabel: 'Category',
        oldDisplayValue: 'Operational',
        newDisplayValue: 'Strategic',
    },
    ...
    CONTROL_OWNER_CHANGE: {
        ...
        oldDisplayValue: 'Tomáš Novotný',
        newDisplayValue: 'Jana Horáková',
    },
