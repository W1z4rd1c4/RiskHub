...
import type { ResolveOrphanRequest, ResolveOrphanResponse } from '../types/orphanedItem';
...
export const orphanedItemsApi = {
    ...
    resolveOrphan: (id: number, data: ResolveOrphanRequest): Promise<ResolveOrphanResponse> =>
