...
export const businessRoutes: AppRouteDef[] = [
  ...
  },
  {
    ...
    nav: {
      ...
      labelKey: 'controls',
      icon: ClipboardList,
      isVisible: ({ authz, hasPermission }) => !authz.isPlatformAdmin && hasPermission('controls', 'read'),
      order: 30,
    },
  },
  ...
  { key: 'controls-edit', path: 'controls/:id/edit', element: <ControlEditPage /> },
  {
    ...
    nav: {
      ...
      labelKey: 'risks',
      icon: ShieldAlert,
      isVisible: ({ authz, hasPermission }) => !authz.isPlatformAdmin && hasPermission('risks', 'read'),
      order: 40,
    },
  },
  {
  ...
  { key: 'vendors-edit', path: 'vendors/:id/edit', element: <VendorDetailPage mode="edit" /> },
  {
    ...
    nav: {
      ...
      icon: Building2,
      isVisible: ({ authz, hasPermission }) => !authz.isPlatformAdmin && hasPermission('departments', 'read'),
      order: 80,
    },
  },
