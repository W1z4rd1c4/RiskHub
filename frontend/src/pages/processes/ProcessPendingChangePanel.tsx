...
interface ProcessPendingChangePanelProps {
    pendingChange: ProcessPendingChangeRead;
    locale?: string;
    cancelling?: boolean;
    onCancel?: () => void;
}

export function ProcessPendingChangePanel({
    pendingChange,
    locale = 'en',
    cancelling = false,
    onCancel,
}: ProcessPendingChangePanelProps) {
    ...
    return (
        <section
            ...
            data-testid="process-pending-change"
            aria-labelledby="process-pending-change-title"
        >
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
                <div>
                    <div className="flex flex-wrap items-center gap-2">
                        <h2 id="process-pending-change-title" className="text-sm font-black uppercase tracking-widest text-amber-200">
