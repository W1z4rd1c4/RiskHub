...
export function VendorsTableSection({
    ...
    const localizedErrorMessage = errorKey ? t(errorKey, { ns: 'errorKeys' }) : undefined;
                ...
                <table className="w-full">
                    ...
                    <tbody>
                        {Array.from({ length: itemsPerPage }, (_, i) => (
                            <tr key={`vendor-skeleton-${i}`} className="border-b border-white/5 animate-pulse" aria-hidden="true">
