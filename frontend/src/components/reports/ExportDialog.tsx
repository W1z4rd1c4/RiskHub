...
export function ExportDialog({
    ...
    const formatOptions = useMemo(
        () => [
            { value: 'xlsx', label: t('export.formats.xlsx', 'Excel (.xlsx)') },
            { value: 'pdf', label: t('export.formats.pdf', 'PDF (.pdf)') },
                ...
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">
                                    {t('export.fields.date', 'As of date')}
                                </label>
                                <input
                                    type="date"
                                    value={asOfDate}
                        ...
                        <div className="p-6 border-t border-white/5 flex items-center justify-end gap-3 bg-white/[0.02]">
                            ...
                            >
                                {t('export.actions.cancel', t('actions.cancel', 'Cancel'))}
                            </button>
                            <button
                                type="button"
                            ...
                            >
                                ...
                                {t('export.actions.submit', 'Export')}
                            </button>
                        </div>
                    </motion.div>
                </div>
