...
const DEFAULT_LINK_CLASS =
    'px-5 py-2.5 rounded-xl bg-accent/20 border border-accent/30 text-accent-text font-bold hover:bg-accent/30 transition-all flex items-center gap-2 w-fit';
