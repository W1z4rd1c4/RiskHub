...
- [`backend/app/core/config.py`](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/core/config.py) - Added `webhook_secret` setting
- [`backend/app/api/v1/endpoints/directory.py`](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/api/v1/endpoints/directory.py) - Added signature verification logic
- [`backend/tests/test_directory_sync.py`](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/tests/test_directory_sync.py) - Added 3 webhook auth tests
