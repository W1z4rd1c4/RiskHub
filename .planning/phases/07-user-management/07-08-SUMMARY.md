...
### [reports.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/api/v1/endpoints/reports.py)
...
### [report_service.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/services/report_service.py)
...
### [directory_sync_log.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/models/directory_sync_log.py)
- Changed `JSONB` → `JSON` for SQLite test compatibility

### [directory_user.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/models/directory_user.py)
- Changed `JSONB` → `JSON` for SQLite test compatibility

### [conftest.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/tests/conftest.py)
- Added `reports:read` permission to employee fixture

### [NEW] [test_reports_rbac.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/tests/test_reports_rbac.py)
