...
- [`backend/app/core/config.py`](../../../backend/app/core/config.py) - Changed defaults to False
- [`backend/app/main.py`](../../../backend/app/main.py) - Added startup security checks
- [`backend/.env.example`](../../../backend/.env.example) - Created with documentation
- [`backend/.env`](../../../backend/.env) - Added MOCK_AUTH_ENABLED=true
