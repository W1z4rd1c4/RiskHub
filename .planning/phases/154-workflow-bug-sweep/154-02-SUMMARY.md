...
| File | Changes |
|------|---------|
| [controls.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/api/v1/endpoints/controls.py) | Added `is_control_owner` checks to 3 endpoints |
| [kris.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/api/v1/endpoints/kris.py) | Added ownership checks to history endpoint |
| [test_cross_department_access.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/tests/test_cross_department_access.py) | Added 3 control-side linking tests |
| [test_kris_rbac.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/tests/test_kris_rbac.py) | Added 2 KRI history cross-dept tests |
