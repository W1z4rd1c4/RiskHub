...
- `GET /risks/{id}` → [L266-270](../../../backend/app/api/v1/endpoints/risks.py#L266-L270) checks `is_risk_kri_reporting_owner` and `is_risk_control_owner`
- `GET /risks/{id}/controls` → [L706-719](../../../backend/app/api/v1/endpoints/risks.py#L706-L719) mirrors same pattern
- `POST /risks/{id}/controls` → [L753-779](../../../backend/app/api/v1/endpoints/risks.py#L753-L779) checks ownership for both risk and control

The **control-side** endpoints (`controls.py`) are inconsistent:

- `GET /controls/{id}` → [L242-246](../../../backend/app/api/v1/endpoints/controls.py#L242-L246) correctly checks `is_control_owner` ✅
- `GET /controls/{id}/risks` → [L759-760](../../../backend/app/api/v1/endpoints/controls.py#L759-L760) **department-only** ❌
- `POST /controls/{id}/risks` → [L792](../../../backend/app/api/v1/endpoints/controls.py#L792) **department-only** ❌
- `DELETE /controls/{id}/risks/{rid}` → [L860](../../../backend/app/api/v1/endpoints/controls.py#L860) **department-only** ❌
- `GET /controls/{id}/executions` → [L727-729](../../../backend/app/api/v1/endpoints/controls.py#L727-L729) correctly checks owner ✅
- `POST /controls/{id}/executions` → [L676-678](../../../backend/app/api/v1/endpoints/controls.py#L676-L678) correctly checks owner ✅
