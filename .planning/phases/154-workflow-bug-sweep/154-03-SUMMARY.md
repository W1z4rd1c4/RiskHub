...
| File | Changes |
|------|---------|
| [risks.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/api/v1/endpoints/risks.py) | Added `process` and `category` query params + filter logic |
| [risk.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/schemas/risk.py) | Added `description` to `RiskBriefForLink` |
