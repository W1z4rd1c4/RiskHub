...
- [orphaned_item_service.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/services/orphaned_item_service.py) - Standardized all timestamp usage to `datetime.utcnow()`
- [seed_kris.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/scripts/seed_kris.py) - Added argparse, `--force`/`--report` flags, removed global fallback
- [verify_data_consistency.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/scripts/verify_data_consistency.py) - Added pagination iteration, auth header support
