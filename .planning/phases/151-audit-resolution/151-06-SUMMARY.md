...
### Backend
- [risks.py](../../../backend/app/api/v1/endpoints/risks.py) - Added `min_net_score` filter parameter

### Frontend
- [executionApi.ts](../../../frontend/src/services/executionApi.ts) - Fixed ExecutionResult enum values
- [AuditTrailPage.tsx](../../../frontend/src/pages/AuditTrailPage.tsx) - Updated result icons, colors, filter options
- [riskApi.ts](../../../frontend/src/services/riskApi.ts) - Added min_net_score parameter
- [RisksPage.tsx](../../../frontend/src/pages/RisksPage.tsx) - Removed per-risk KRI/control fetches, use server-side critical filter
