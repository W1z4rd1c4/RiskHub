...
- [usePermissions.ts](../../../frontend/src/hooks/usePermissions.ts) - Added `canViewUsers` permission helper
- [UsersPage.tsx](../../../frontend/src/pages/UsersPage.tsx) - Gated edit/deactivate actions, updated role filter options
- [UserNewPage.tsx](../../../frontend/src/pages/UserNewPage.tsx) - Added permission redirect, safe default role selection
- [UserDetailPage.tsx](../../../frontend/src/pages/UserDetailPage.tsx) - Read-only mode for non-privileged users
