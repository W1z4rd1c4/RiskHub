...
- Updated `/Users/stefanlesnak/Antigravity/Risk App 2/backend/tests/test_reports_rbac.py` to:
...
- Updated user/business docs to match delivered export UX and scope semantics:
  ...
  - `/Users/stefanlesnak/Antigravity/Risk App 2/docs/user/README.md`
  ...
  - `/Users/stefanlesnak/Antigravity/Risk App 2/docs/user/vendors.md` (added)

## Verification Results

1. `cd /Users/stefanlesnak/Antigravity/Risk App 2/backend && venv/bin/pytest tests/test_reports_rbac.py tests/test_vendor_reports.py -q`  
...
3. `cd /Users/stefanlesnak/Antigravity/Risk App 2/frontend && npx playwright test e2e/risks.spec.ts e2e/controls.spec.ts e2e/kris.spec.ts e2e/vendors.spec.ts --project=chromium`  
   Result: `19 passed`
4. `cd /Users/stefanlesnak/Antigravity/Risk App 2 && make test-e2e`  
