...
- Added unified export endpoints in `/Users/stefanlesnak/Antigravity/Risk App 2/backend/app/api/v1/endpoints/reports.py`:
...
- Added `/Users/stefanlesnak/Antigravity/Risk App 2/backend/app/services/export_snapshot_service.py`.
...
- Extended `/Users/stefanlesnak/Antigravity/Risk App 2/backend/app/services/report_service.py` with reusable generators:
...
### Test Coverage
- Extended `/Users/stefanlesnak/Antigravity/Risk App 2/backend/tests/test_reports_rbac.py` with:
...
## Verification
- `cd /Users/stefanlesnak/Antigravity/Risk App 2/backend && venv/bin/pytest tests/test_reports_rbac.py -q`  
  Result: `16 passed`
- `cd /Users/stefanlesnak/Antigravity/Risk App 2/backend && venv/bin/pytest tests/test_vendor_reports.py tests/test_kris_rbac.py tests/test_vendors.py tests/api/v1/test_reports_audit.py -q`  
  Result: `28 passed`
