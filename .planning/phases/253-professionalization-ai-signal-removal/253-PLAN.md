...
4. Approval execution boundary cleanup with explicit admin log-config application and validated startup restoration of persisted log rotation.
5. Frontend route/export unification through the central typed route registry.
...
- `cd frontend && npm run test:run -- src/pages src/services src/contexts`
