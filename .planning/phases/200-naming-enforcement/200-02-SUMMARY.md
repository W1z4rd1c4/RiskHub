...
### Pydantic Schemas
- **[risk.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/schemas/risk.py)**:
...
- **[kri.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/schemas/kri.py)**:
...
### Test Updates
- **[conftest.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/tests/conftest.py)**: Added `name` to `test_risk` fixture
- **[test_risks.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/tests/test_risks.py)**: Added `name` to all risk creation payloads
- **[test_kris_rbac.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/tests/test_kris_rbac.py)**: Added `name` to Risk fixtures, `description` to KRI fixtures and API payloads
