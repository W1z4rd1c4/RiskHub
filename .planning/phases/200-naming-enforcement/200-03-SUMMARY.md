...
### TypeScript Types ([risk.ts](file:///Users/stefanlesnak/Antigravity/Risk%20App/frontend/src/types/risk.ts))
- Added `name: string` to `Risk` interface
- Added `name: string` to `RiskSummary` interface
- Added `name: string` to `RiskCreate` interface

### Risks Page ([RisksPage.tsx](file:///Users/stefanlesnak/Antigravity/Risk%20App/frontend/src/pages/RisksPage.tsx))
...
### Backend Search ([risks.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/api/v1/endpoints/risks.py))
