...
### Backend Models
- **[risk.py](../../../backend/app/models/risk.py)**: Added `name: Mapped[str]` field with index
- **[key_risk_indicator.py](../../../backend/app/models/key_risk_indicator.py)**: Added `description: Mapped[str]` field

### Database Migration
- **[cfd46dc4cb71_add_name_to_risks_and_description_to_.py](../../../backend/alembic/versions/cfd46dc4cb71_add_name_to_risks_and_description_to_.py)**: Created migration with:
