...
| File | Action |
|------|--------|
| [DepartmentDetailPage.tsx](file:///Users/stefanlesnak/Antigravity/Risk%20App/frontend/src/pages/DepartmentDetailPage.tsx) | MODIFIED - Per-tab pagination + server-side filtering |
| [departmentApi.ts](file:///Users/stefanlesnak/Antigravity/Risk%20App/frontend/src/services/departmentApi.ts) | MODIFIED - Added `min_net_score` param |
| [userApi.ts](file:///Users/stefanlesnak/Antigravity/Risk%20App/frontend/src/services/userApi.ts) | MODIFIED - Added `department_id` param |
| [departments.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/app/api/v1/endpoints/departments.py) | MODIFIED - Added `min_net_score` query param |
| [test_departments.py](file:///Users/stefanlesnak/Antigravity/Risk%20App/backend/tests/test_departments.py) | NEW - 3 tests for min_net_score + pagination |
