...
- `tests/backend/pytest/` - 453 tracked test files (415 Python)
...
### Primary subdirectories
- `frontend/src/pages/` - 228 tracked files (measured git-tracked snapshot; route-level pages + colocated helpers/tests and shared detail/admin/user workflow modules)
...
- `tests/frontend/e2e/` - 57 E2E specs among 97 tracked files (measured git-tracked `*.spec.ts` snapshot; domain-focused test suites plus setup/helpers/fixtures and the dialog render-site harness)
