...
- `tests/backend/pytest/` - 458 tracked test files (420 Python)
...
- `tests/frontend/e2e/` - 61 E2E specs among 102 tracked files (measured git-tracked `*.spec.ts` snapshot; domain-focused test suites plus setup/helpers/fixtures and the dialog render-site harness)
