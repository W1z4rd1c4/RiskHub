...
- `backend/app/api/v1/endpoints/` - 167 Python modules/packages (measured `*.py` snapshot; extensively split into subrouters for maintainability)
...
- `tests/backend/pytest/` - 335 tracked test files (312 Python)
