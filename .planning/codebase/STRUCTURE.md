...
- `tests/backend/pytest/` - 454 tracked test files (416 Python)
...
### Primary subdirectories
- `frontend/src/pages/` - 231 tracked files (measured git-tracked snapshot; route-level pages + colocated helpers/tests and shared detail/admin/user workflow modules)
...
- `tests/frontend/e2e/` - 58 E2E specs among 98 tracked files (measured git-tracked `*.spec.ts` snapshot; domain-focused test suites plus setup/helpers/fixtures and the dialog render-site harness)
