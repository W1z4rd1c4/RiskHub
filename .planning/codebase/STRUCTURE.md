...
- `tests/backend/pytest/` - 457 tracked test files (419 Python)
...
### Primary subdirectories
- `frontend/src/pages/` - 234 tracked files (measured git-tracked snapshot; route-level pages + colocated helpers/tests and shared detail/admin/user workflow modules)
...
- `tests/frontend/e2e/` - 60 E2E specs among 101 tracked files (measured git-tracked `*.spec.ts` snapshot; domain-focused test suites plus setup/helpers/fixtures and the dialog render-site harness)
