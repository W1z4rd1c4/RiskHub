...
- `backend/app/api/v1/endpoints/` - 162 Python modules/packages (measured git-tracked `*.py` snapshot; extensively split into subrouters for maintainability)
...
- `tests/backend/pytest/` - 437 tracked test files (399 Python)
