...
- `tests/backend/pytest/` - 455 tracked test files (417 Python)
...
- `tests/frontend/e2e/` - 59 E2E specs among 99 tracked files (measured git-tracked `*.spec.ts` snapshot; domain-focused test suites plus setup/helpers/fixtures and the dialog render-site harness)
