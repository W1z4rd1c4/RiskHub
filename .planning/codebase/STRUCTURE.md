...
- `tests/backend/pytest/` - 444 tracked test files (406 Python)
...
### Primary subdirectories
- `frontend/src/pages/` - 221 tracked files (measured git-tracked snapshot; route-level pages + colocated helpers/tests and shared detail/admin/user workflow modules)
