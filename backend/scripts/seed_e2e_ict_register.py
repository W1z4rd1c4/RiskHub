...
def _assert_asset_controlled_codes(entry: dict[str, object]) -> None:
...
E2E_ASSETS = [
    {
        ...
        "business_owner_email": "ops.head@riskhub.local",
        "ict_owner_email": "it.head@riskhub.local",
        "owning_department": "Operations",
        "gdpr_relevance": "yes",
        "ai_relevance": "no",
    ...
    {
        # Same-user case: the IT head legitimately holds both Asset roles.
        ...
        "business_owner_email": "it.head@riskhub.local",
        "ict_owner_email": "it.head@riskhub.local",
        "owning_department": "IT",
        "gdpr_relevance": "undetermined",
        "ai_relevance": "no",
    ...
    },
    {
        ...
        # dedicated target of the UI asset<->asset link test. Ownership is
        # intentionally cross-department while the optional metadata is blank.
        ...
        "alternative_names": None,
        "business_owner_email": "fin.head@riskhub.local",
        "ict_owner_email": "it.head@riskhub.local",
        "owning_department": "Finance",
        "gdpr_relevance": None,
        "ai_relevance": None,
    ...
    {
        # Ticket #75 owner-scope matrix: both accountable employees sit
        # outside the Finance owning department, while the Finance head gets
        # the independent Owning Department Head record exception.
        "name": "E2E-ASSET-005 Cross-Department Owner Scope",
        "asset_type": "cloud_service",
        "asset_level": "supporting",
        "description": "Distinct Business and ICT owners outside the owning department.",
        "physical_location": "EU cloud region",
        "deployment_model": "saas",
        "alternative_names": "Owner Scope Matrix",
        ...
        "last_legacy_risk_assessment_date": None,
        "review_state": "reviewed",
        "notes": "Deterministic record-specific Asset authorization fixture.",
        "is_archived": False,
    },
    {
        # Archived counterpart proves assignment alone never grants restore.
        "name": "E2E-ASSET-OWNER-ARCH Archived Owner Scope",
        "asset_type": "cloud_service",
        "asset_level": "supporting",
        "description": "Archived counterpart of the cross-department owner fixture.",
        "physical_location": "EU cloud region",
        "deployment_model": "saas",
        "alternative_names": None,
        "business_owner_email": "ops.analyst@riskhub.local",
        ...
        "standard_support_end_date": date(2024, 12, 31),
        "extended_support_end_date": None,
        "custom_support_end_date": None,
        "last_legacy_risk_assessment_date": date(2025, 9, 1),
        "review_state": "reviewed",
        "notes": "Owner assignment does not grant archive or restore capability.",
        "is_archived": True,
    },
    {
...
async def seed_ict_register():
    ...
    async with session_context(get_settings()) as db:
        ...
        for entry in E2E_ASSETS:
            ...
            _assert_asset_controlled_codes(entry)
            is_archived = bool(entry["is_archived"])
            payload = {
                key: value
                for key, value in entry.items()
            ...
            payload.update(
                {
                    "business_owner_user_id": require_user_id(users, entry["business_owner_email"]),
                    "ict_owner_user_id": require_user_id(users, entry["ict_owner_email"]),
                    "owning_department_id": require_department_id(departments, entry["owning_department"]),
                    "is_archived": is_archived,
                    "archived_at": now if is_archived else None,
                    "archived_by_id": archiver_id if is_archived else None,
                }
