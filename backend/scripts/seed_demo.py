...
DEMO_USERS = [
    {"id": 1, "name": "System Admin", "email": "admin@riskhub.local", "role": "admin", "access": "global", "dept": None},
    {"id": 2, "name": "Anna Kowalski", "email": "cro@riskhub.local", "role": "cro", "access": "global", "dept": None},
    {"id": 3, "name": "Petra Svobodová", "email": "risk.manager@riskhub.local", "role": "risk_manager", "access": "global", "dept": None},
    {"id": 4, "name": "Eva Králová", "email": "ops.head@riskhub.local", "role": "department_head", "access": "department", "dept": "Operations"},
    {"id": 5, "name": "Martin Procházka", "email": "fin.head@riskhub.local", "role": "department_head", "access": "department", "dept": "Finance"},
    {"id": 6, "name": "Tomáš Novotný", "email": "it.head@riskhub.local", "role": "department_head", "access": "department", "dept": "IT"},
    {"id": 7, "name": "Jana Horáková", "email": "ops.analyst@riskhub.local", "role": "employee", "access": "department", "dept": "Operations"},
    {"id": 8, "name": "Lukáš Dvořák", "email": "fin.analyst@riskhub.local", "role": "employee", "access": "department", "dept": "Finance"},
    {"id": 9, "name": "Barbora Němcová", "email": "it.analyst@riskhub.local", "role": "employee", "access": "department", "dept": "IT"},
]
...
async def seed_all():
    async with async_session_maker() as db:
        ...
        risks = [
            {"name": "Data Breach Risk", "process": "IT Security", "dept": "IT", "owner": "it.head@riskhub.local", "gross": 16, "net": 10, "priority": True},
            {"name": "Financial Reporting Error", "process": "Finance", "dept": "Finance", "owner": "fin.head@riskhub.local", "gross": 12, "net": 8, "priority": False},
            {"name": "Operational Downtime", "process": "Operations", "dept": "Operations", "owner": "ops.head@riskhub.local", "gross": 9, "net": 6, "priority": False},
            {"name": "Compliance Violation", "process": "Compliance", "dept": "Compliance", "owner": "cro@riskhub.local", "gross": 20, "net": 12, "priority": True},
            {"name": "Vendor Risk", "process": "Operations", "dept": "Operations", "owner": "ops.head@riskhub.local", "gross": 8, "net": 4, "priority": False},
        ]
        risk_map = {}
        for r in risks:
            risk = Risk(
        ...
        controls = [
            ...
            {"name": "Financial Reconciliation", "dept": "Finance", "owner": "fin.analyst@riskhub.local", "freq": "weekly"},
            {"name": "Operational Checklist", "dept": "Operations", "owner": "ops.analyst@riskhub.local", "freq": "daily"},
        ...
        control_map = {}
        freq_map = {"daily": ControlFrequency.daily, "weekly": ControlFrequency.weekly, 
                    "monthly": ControlFrequency.monthly, "quarterly": ControlFrequency.quarterly,
        ...
        kris = [
            {"name": "System Uptime", "risk": "Operational Downtime", "owner": "ops.analyst@riskhub.local", "value": 99.5, "lower": 95, "upper": 100},
            {"name": "Security Incidents", "risk": "Data Breach Risk", "owner": "it.analyst@riskhub.local", "value": 2, "lower": 0, "upper": 5},
            {"name": "Audit Findings", "risk": "Compliance Violation", "owner": "cro@riskhub.local", "value": 3, "lower": 0, "upper": 10},
            {"name": "Reconciliation Errors", "risk": "Financial Reporting Error", "owner": "fin.analyst@riskhub.local", "value": 1, "lower": 0, "upper": 3},
        ]
        for k in kris:
