...
Examples:
  ...
  python seed_kris.py --force --report out.txt # Seed and write unmatched to file
    ...
    parser.add_argument(
        "--excel", type=str, metavar="PATH", help="Path to Excel file (default: Register rizik - limity - Q3.xlsx)"
    )
...
async def seed_kris(force: bool = False, report_file: str | None = None, excel_path: str | None = None):
    ...
    if excel_path:
        ...
        excel = Path(__file__).parent.parent.parent / "Register rizik - limity - Q3.xlsx"
