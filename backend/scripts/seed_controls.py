...
from app.models import Control, ControlForm, ControlFrequency, ControlStatus, Department, Risk
    ...
    mock_risks = [
        {
            ...
            "description": (
                "Risk of reputational damage from negative social media campaigns or "
