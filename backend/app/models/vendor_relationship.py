...
from sqlalchemy import DateTime, ForeignKey, Integer, String, Enum as SAEnum, UniqueConstraint, Index, func
...
class VendorRelationship(Base):
    ...
    related_vendor_id: Mapped[int] = mapped_column(Integer, ForeignKey("vendors.id", ondelete="CASCADE"), nullable=False, index=True)
