...
RBAC_ROLE_PERMISSIONS: dict[str, tuple[str, ...]] = {
    ...
    "cro": ("*:*",),
    "risk_manager": ("controls:*", "risks:*", "issues:*", "vendors:*", "departments:read", "reports:*", "users:read", "approvals:write", "activity_log:read", "kri:submit"),
    "actuarial": ("controls:read", "controls:write", "risks:read", "vendors:read", "reports:read"),
    "compliance": ("controls:read", "controls:write", "risks:read", "issues:read", "vendors:read", "reports:read", "vendor_contracts:*"),
    "internal_audit": ("controls:read", "risks:read", "issues:read", "vendors:read", "departments:read", "reports:read"),
    "department_head": ("controls:read", "controls:write", "risks:read", "issues:read", "issues:write", "vendors:read", "vendors:write", "departments:read", "reports:read", "kri:submit", "activity_log:read"),
