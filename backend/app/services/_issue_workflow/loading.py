...
async def get_issue_with_relations(db: AsyncSession, issue_id: int) -> Issue | None:
...
_get_issue_with_relations = get_issue_with_relations
_get_readable_issue_or_404 = get_readable_issue_or_404
_get_writable_issue_or_404 = get_writable_issue_or_404
