...
MESSAGES = {
    ...
    "notifications": {
        ...
        "questionnaire_submitted_message": (
            "{actor_name} submitted the risk assessment questionnaire for '{risk_name}'."
        ),
        ...
        "vendor_assessment_committee_recommended_message": (
            "A committee recommendation was recorded for vendor '{vendor_name}'."
        ),
