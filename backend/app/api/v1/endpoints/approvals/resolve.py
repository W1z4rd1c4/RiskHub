...
async def get_pending_count(
    ...
    """
    return await count_pending_approval_queue(db=db, current_user=ctx.user)
...
async def list_my_approval_requests(
    ...
    """
    return await list_my_approval_queue_page(db=db, current_user=ctx.user, skip=skip, limit=limit)
