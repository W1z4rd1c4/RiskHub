...
2. **Renames Files Consistently**: Creates standardized filenames:
   - Format: `placeholder-pdf-042.pdf`
   - Examples: `placeholder-pdf-006.pdf`
...
"placeholder-pdf-041.pdf" format, 
...
4. **Create Standardized Filename**
   ...
   Examples:
   - `placeholder-pdf-006.pdf`
   - `placeholder-pdf-002.pdf`
   - `placeholder-pdf-001.pdf`
...
5. **Execute Organization**
   ...
   Before: `placeholder-pdf-030.pdf`
   After: `placeholder-pdf-006.pdf`
   ...
   cp "placeholder-pdf-032.pdf" "Invoices/2024/Software/Adobe/placeholder-pdf-006.pdf"
   
   # Or move if user prefers
   mv "placeholder-pdf-032.pdf" "new/path/placeholder-pdf-039.pdf"
   ```
...
6. **Generate Summary Report**
   ...
   2024-03-15,Adobe,INV-12345,Creative Cloud,52.99,Software,Invoices/2024/Software/Adobe/placeholder-pdf-006.pdf
   2024-03-10,Amazon,123-4567890-1234567,Office Supplies,127.45,Office,Invoices/2024/Office/Amazon/placeholder-pdf-003.pdf
   ...
   ```
...
3. Renames all files: `placeholder-pdf-041.pdf`
...
**User**: "I download invoices from Gmail. They're all named 'placeholder-pdf-029.pdf', 'placeholder-pdf-027.pdf', etc. Fix this mess."
...
Renamed examples:
- placeholder-pdf-029.pdf → placeholder-pdf-007.pdf
- placeholder-pdf-027.pdf → placeholder-pdf-005.pdf
- placeholder-pdf-028.pdf → placeholder-pdf-004.pdf
