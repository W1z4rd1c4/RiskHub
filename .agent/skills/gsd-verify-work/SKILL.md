...
<execution_context>
.agent/skills/gsd/workflows/verify-work.md
...
8. If issues found:
   - Execute sequential debug analysis to diagnose root causes
   - Execute gsd-planner in --gaps mode to create fix plans
   - Execute gsd-plan-checker to verify fix plans
   - Iterate planner ↔ checker until plans pass (max 3)
   - Present ready status with `/clear` then `/gsd:execute-phase`
</process>

<anti_patterns>
- Don't use notify_user or inline question for test responses — plain text conversation
