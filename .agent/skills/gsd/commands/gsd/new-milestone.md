...
When you could update PROJECT.md with clear new goals, use notify_user or inline question:
...
Perform 4 sequential gsd-project-researcher analysis passes with context:
...
After all 4 agents complete, execute synthesizer:
