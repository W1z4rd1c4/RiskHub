...
description: Verifies plans will achieve phase goal before execution. Goal-backward analysis of plan quality. Used by /gsd:plan-phase orchestrator.
...
**Dependency rules:**
- `depends_on: []` = Wave 1 (can run in same wave)
...
- Could split for better efficiency
