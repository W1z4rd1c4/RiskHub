# Debug execution step Prompt Template

Template for running gsd-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, execution step_type="gsd-debugger", description="Debug UAT-001")
```
...
For checkpoints, Execute fresh process with:
