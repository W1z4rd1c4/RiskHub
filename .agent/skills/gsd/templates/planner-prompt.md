# Planner execution step Prompt Template

Template for running gsd-planner agent. The agent contains all planning expertise - this template provides planning context only.
