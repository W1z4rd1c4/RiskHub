...
**commands/gsd/**
- Purpose: Slash command definitions for Platform Team
...
- `README.md` - Instructions for Platform Team when working in this repo
...
- Usage: Reference from command with `@.agent/skills/gsd/workflows/{name}.md`
