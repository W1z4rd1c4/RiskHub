...
See .agent/skills/gsd/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
7. **Create DISCOVERY.md** using .agent/skills/gsd/templates/discovery.md structure:
...
1. **Scope the discovery** using .agent/skills/gsd/templates/discovery.md:
...
7. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from .agent/skills/gsd/templates/discovery.md
...
Use .agent/skills/gsd/templates/discovery.md.
