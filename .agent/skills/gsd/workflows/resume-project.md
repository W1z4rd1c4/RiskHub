...
- execution step was used but session ended before completion
...
⚠️  Interrupted agent detected:
    ...
    Resume with: task instructions (resume parameter with agent ID)
...
→ Primary: Resume interrupted agent (task instructions with resume parameter)
