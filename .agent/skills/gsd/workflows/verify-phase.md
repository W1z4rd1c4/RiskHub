...
This workflow is executed by a verification execution step used from execute-phase.md.
</purpose>
...
- .agent/skills/gsd/references/verification-patterns.md (detection patterns)
- .agent/skills/gsd/templates/verification-report.md (output format)
</required_reading>
...
See .agent/skills/gsd/templates/verification-report.md for complete template.
</step>
