...
**Then use notify_user or inline question (multiSelect: true):**
- header: "Discuss"
...
2. **Ask 4 questions using notify_user or inline question:**
   - header: "[Area]"
   - question: Specific decision for this area
   - options: 2-3 concrete choices (notify_user or inline question adds "Other" automatically)
