...
**GSD** (Get Shit Done) creates hierarchical project plans optimized for solo agentic development with Platform Team.
...
- Optional domain research (runs 4 sequential researcher analysis)
...
- Analyzes codebase with sequential Explore analysis
...
- Plans within each wave run sequentially via task instructions
